...
const steps: StepConfig[] = [
  {
    id: "hairTime",
    title: "How much time do you spend on your hair every day?",
    description: "We offer treatments that are quick, simple, and work with your routine.",
    options: ["Less than 5 minutes", "5–10 minutes", "10+ minutes"],
    field: "hairTime",
  },
  {
    id: "hairConcern",
    title: "What is your main hair concern?",
    description: "Select the one that bothers you the most right now.",
    options: ["Hair loss / thinning", "Dry & damaged", "Dandruff", "Premature graying", "Other"],
    field: "hairConcern",
  },
  {
    id: "ageGroup",
    title: "Which age group do you belong to?",
    description: "This helps us recommend the most suitable products.",
